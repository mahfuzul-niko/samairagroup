            ...
            <div class="card-body ">
                ...
                <div class="text-center my-3">
                    <div class=" d-inline-block" style="height: 150px; width: auto;">
                        ...
                        <form action="{{ route('agent.system.destroy.image', 'samaira_aviation_logo') }}" method="POST"
                            class="mt-2">
                            @csrf
                ...
                <form action="{{ route('agent.system.storeImage') }}" class="mt-2" method="POST"
                    ...
                    <input type="hidden" name="key" placeholder="Enter key" class="form-control"
                        value="samaira_aviation_logo" required>
        ...
        <div class="card">
            <div class="card-body ">
                ...
                <form action="{{ route('agent.content.store.banner') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="key" value="aviation" class="form-control" required>
                    <div class="form-group my-3">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('agent.content.update.banner', $banner) }}"
                                            ...
                                            @csrf
                                            <input type="hidden" name="key" value="aviation"
    ...
    <section class="airline">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('agent.aviation.store.airline') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="">Title</label>
                ...
                <table class="table">
                    ...
                    @foreach ($airlines as $airline)
                        <tr>
                            <td>{{ $airline->title }}</td>
                            <td>
                                <img src="{{ $airline->image ? Storage::url($airline->image) : asset('assets/img/no-profile.png') }}"
                                    alt="Banner Image" class="img-fluid" style="height: 100px; object-fit: cover;">
                            </td>
                            <td>
