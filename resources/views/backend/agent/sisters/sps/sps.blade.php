        ...
        <div class="card">
            <div class="card-body ">
                ...
                <form action="{{ route('agent.content.store.banner') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="key" value="sps" class="form-control" required>
                    <div class="form-group my-3">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('agent.content.update.banner', $banner) }}"
                                            ...
                                            @csrf
                                            <input type="hidden" name="key" value="sps" class="form-control"
                                                required>
                                            <div class="form-group my-3">
                                                <label for="banner">Banner Image</label>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <img class="img-fluid " style="height: 200px"
                        src="{{ system_key('samaira_sps_review') ? Storage::url(system_key('samaira_sps_review')) : asset('assets/img/no-profile.png') }}"
                        alt="">
                    <form action="{{ route('agent.system.destroy.image', 'samaira_sps_review') }}" method="POST"
                        class="mt-2">
                        @csrf
                        <button type="submit" class="btn btn-outline-danger btn-sm">Remove</button>
                    </form>
                ...
                <form action="{{ route('agent.system.storeImage') }}" class="mt-2" method="POST"
                    ...
                    @csrf
                    <input type="hidden" name="key" placeholder="Enter key" class="form-control"
                        value="samaira_sps_review" required>
                    <div class="form-group my-3">
                        <label for="value">Background Image</label>
                        <input type="file" name="value" value="samaira_sps_review" class="form-control"
                            required>
                    </div>
