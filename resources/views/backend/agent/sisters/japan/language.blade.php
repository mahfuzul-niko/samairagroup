            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <img class="img-fluid " style="height: 200px"
                        src="{{ system_key('samaira_language_review') ? Storage::url(system_key('samaira_language_review')) : asset('assets/img/no-profile.png') }}"
                        alt="">
                    <form action="{{ route('agent.system.destroy.image', 'samaira_language_review') }}" method="POST"
                        class="mt-2">
                        @csrf
                        <button type="submit" class="btn btn-outline-danger btn-sm">Remove</button>
                    </form>
                ...
                <form action="{{ route('agent.system.storeImage') }}" class="mt-2" method="POST"
                    ...
                    @csrf
                    <input type="hidden" name="key" placeholder="Enter key" class="form-control"
                        value="samaira_language_review" required>
                    <div class="form-group my-3">
                        <label for="value">Background Image</label>
                        <input type="file" name="value" value="samaira_language_review" class="form-control"
                            required>
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm">Upload</button>
                </form>
