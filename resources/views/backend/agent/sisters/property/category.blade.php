     ...
     <section class="category">
        <div class="card">
            <div class="card-body ">
                ...
                <form action="{{ route('agent.jphomes.store.category') }}" method="POST">
                    @csrf
                    ...
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                ...
                                <form action="{{ route('agent.jphomes.delete.category', $category) }}"
                                    method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form
                                                action="{{ route('agent.jphomes.update.category', $category) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group my-3">
                                                    <label for="category">Category Name</label>
