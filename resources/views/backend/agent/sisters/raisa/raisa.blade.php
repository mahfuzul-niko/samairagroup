<x-app>
        ...
        <div class="card">
            <div class="card-body ">
                ...
                <form action="{{ route('agent.content.store.banner') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="key" value="raisa" class="form-control" required>
                    <div class="form-group my-3">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('agent.content.update.banner', $banner) }}"
                                            ...
                                            @csrf
                                            <input type="hidden" name="key" value="raisa" class="form-control"
                                                required>
                                            <div class="form-group my-3">
                                                <label for="banner">Banner Image</label>
    ...
    <section class="servises">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('agent.raisa.store.service') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                                ...
                                <div class="text-nowrap">
                                    <a class="btn btn-primary btn-sm d-inline-block" type="button"
                                        data-bs-toggle="modal" data-bs-target="#service{{ $service->id }}"><i
                                            class="bi bi-pen"></i></a>
                                    <form action="{{ route('agent.raisa.delete.service', $service) }}" method="POST"
                                        class="d-inline-block m-0 p-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"><i
                            ...
                            <div class="modal fade" id="service{{ $service->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('agent.raisa.update.service', $service) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="">Image</label>
    ...
    <section class="review">
        <div class="card">
            <div class="card-body">
                <div class="card-title">Raisa Review</div>
                <form action="{{ route('agent.raisa.store.review') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                ...
                <div class="card-title">Raisa Review Table</div>
                <table class="table">
                    <tr>
                        <th>Name</th>
                        <th>Image</th>
                                ...
                                <div class="text-nowrap">
                                    <a class="btn btn-primary btn-sm d-inline-block" type="button"
                                        data-bs-toggle="modal" data-bs-target="#review{{ $review->id }}"><i
                                            class="bi bi-pen"></i></a>
                                    <form action="{{ route('agent.raisa.delete.review', $review) }}" method="POST"
                                        class="d-inline-block m-0 p-0">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"><i
                            ...
                            <div class="modal fade" id="review{{ $review->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('agent.raisa.update.review', $review) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                    <label for="">Name</label>
    ...
    <section class="partners">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('agent.raisa.store.partner') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        ...
                        @foreach ($partners as $partner)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('agent.raisa.delete.partner', $partner) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"><i
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('agent.content.about.store.banner') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="key" value="raisa">
                    <div class="mb-3">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <img class="img-fluid " style="height: 200px"
                        src="{{ system_key('samaira_raisa_review') ? Storage::url(system_key('samaira_raisa_review')) : asset('assets/img/no-profile.png') }}"
                        alt="">
                    <form action="{{ route('agent.system.destroy.image', 'samaira_raisa_review') }}" method="POST"
                        class="mt-2">
                        @csrf
                        <button type="submit" class="btn btn-outline-danger btn-sm">Remove</button>
                    </form>
                ...
                <form action="{{ route('agent.system.storeImage') }}" class="mt-2" method="POST"
                    ...
                    @csrf
                    <input type="hidden" name="key" placeholder="Enter key" class="form-control"
                        value="samaira_raisa_review" required>
                    <div class="form-group my-3">
                        <label for="value">Background Image</label>
                        <input type="file" name="value" value="samaira_raisa_review" class="form-control"
                            required>
                    </div>
