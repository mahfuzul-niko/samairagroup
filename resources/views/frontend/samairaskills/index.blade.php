                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <p class="join-text">Join <span
                                class="highlight">{{ system_key('system_skill_banner_count') }}+ Million</span>
                            Learners today</p>
                        ...
                        <div class="swiper-slide">
                            <div class="course-card h-100">
                                ...
                                <div class="course-content">
                                    ...
                                    <a href="{{ route('page.ssdi.course', $course) }}" class="text-decoration-none">
        ...
        <div class="container pt-4">
            ...
            <div class="category-filters text-center mb-4">
                ...
                @foreach ($categories as $category)
                    <button class="filter-btn capitalize" data-category="{{ $category->title }}">
                        {{ $category->title }}
                    </button>
                @endforeach
            </div>
            ...
            <div class="swiper category-swiper">
                <div class="swiper-wrapper">
                    @foreach ($courses as $course)
                        ...
                        <div class="swiper-slide" data-category="{{$course->category->title}}">
                            <div class="course-card">
                                ...
                                <div class="course-info">
                                    <span class="course-level">{{$course->category->title}}</span>
                                    {{-- <button class="wishlist-btn"><i class="far fa-heart"></i></button> --}}
                                </div>
                                <div class="card-content">
                                    <a href="{{ route('page.ssdi.course', $course) }}" class="text-decoration-none"><h3>{{$course->title}}</h3></a>
                                    <div class="course-meta">
                                        <span><i class="fas fa-book-open"></i>{{$course->total_lessons}} Lessons</span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="enrollment-content">
                        ...
                        <div class="cta-group">
                            <a href="{{ $advertise->link }}" class="btn btn-primary enrollment-btn">Start Free
                                Trial</a>
