...
<section class="enroll-page-section py-5 mb-5">
  <div class="container">
    <div class="text-center mb-4">
      <button class="btn btn-primary fw-bold enroll-apply-btn mb-3 px-5 py-2" type="button">Apply for this Course</button>
      <h2 class="fw-bold mb-4 enroll-title">Your Course Title Here and Batch No</h2>
    </div>
    <div class="row justify-content-center align-items-start g-4 mt-3">
      <div class="col-md-6 d-flex flex-column align-items-center">
        <div class="w-100 d-flex justify-content-center">
          <img src="{{ asset('assets/frontassets/') }}/images/samaira-skills/enroll-page/enroll.jpeg" alt="Course Banner" class="img-fluid rounded-3 enroll-banner-img" />
        </div>
        <button class="btn btn-outline-primary fw-bold mt-4 px-4 py-2 enroll-back-btn" type="button">Back to course <span class="enroll-arrow"><img src="{{ asset('assets/frontassets/') }}/images/samaira-skills/enroll-page/northeastrrow.png" alt="North East Arrow" class="enroll-arrow-img"></span></button>
      </div>
      <div class="col-md-6">
        <form>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <select class="form-select enroll-phone-select">
                <option>+91</option>
              </select>
              <input type="text" class="form-control bg-light" placeholder="Enter your phone no." />
            </div>
          </div>
          <div class="mb-3">
          ...
          <button type="submit" class="btn btn-primary w-100 fw-bold py-2 mb-2 enroll-apply-now-btn">Apply Now <span class="enroll-arrow"><img src="{{ asset('assets/frontassets/') }}/images/samaira-skills/enroll-page/northeastrrow.png" alt="North East Arrow" class="enroll-arrow-img"></span></button>
          <div class="text-center mt-2">
            <span class="fw-bold text-danger mx-2">or</span>
            <span class="fw-bold text-primary"><a href="" class="text-decoration-none">Login</a></span> with Existing account
          </div>
        </form>
      </div>
    </div>
