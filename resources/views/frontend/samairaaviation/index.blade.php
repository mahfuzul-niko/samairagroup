              ...
              <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="journey-input-box clickable" tabindex="0">
                        ...
                        <div class="journey-input-content d-flex align-items-center justify-content-between">
                          ...
                          <input type="text" class="journey-value-input" name="travelers" readonly value="1 Traveler" autocomplete="off">
                        </div>
                          ...
                          <div class="travelers-section">
                            ...
                            <div class="traveler-row">
                              ...
                              <div class="traveler-counter">
                                <button type="button" class="counter-btn minus" data-type="adults">
                                  <i class="fas fa-minus"></i>
                                </button>
                                <span class="counter-value" id="adultsCount">1</span>
                                <button type="button" class="counter-btn plus" data-type="adults">
                            ...
                            <div class="traveler-row">
                              ...
                              <div class="traveler-counter">
                                <button type="button" class="counter-btn minus" data-type="children">
                                  <i class="fas fa-minus"></i>
                                </button>
                                <span class="counter-value" id="childrenCount">0</span>
                                <button type="button" class="counter-btn plus" data-type="children">
                                  <i class="fas fa-plus"></i>
                                </button>
                              </div>
                            </div>
                            ...
                            <div id="childrenAgeContainer" class="children-age-container mt-2"></div>
                            ...
                            <div class="traveler-row">
                              ...
                              <div class="traveler-counter">
                                <button type="button" class="counter-btn minus" data-type="infant">
                                  <i class="fas fa-minus"></i>
                                </button>
                                <span class="counter-value" id="infantCount">0</span>
                                <button type="button" class="counter-btn plus" data-type="infant">
                                  <i class="fas fa-plus"></i>
                                </button>
                              </div>
                            </div>
                            ...
                            <div class="class-selection">
                              ...
                              <div class="class-options">
                                <label class="class-option">
                                  <input type="radio" name="cabinClass" value="economy" checked>
                ...
                <div id="multicity-search-btn-row" class="row">
                  <div class="col-12 d-flex justify-content-center mt-3">
                    <button type="submit" class="btn journey-search-btn"><i class="fas fa-search"></i> Search</button>
                  </div>
                </div>
                </div>
              </div>
      ...
      <div class="row align-items-center mt-3">
        <div class="col-md-12">
          <div class="airline-logos-grid">
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo1.png" alt="Biman Bangladesh Airlines"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo2.png" alt="Saudia"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo3.png" alt="Air Arabia"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo4.png" alt="Qatar Airways"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo5.png" alt="Emirates"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo6.png" alt="IndiGo"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo7.png" alt="US-Bangla Airlines"></div>
            <div class="airline-logo-item"><img src="{{ asset('assets/frontassets/') }}/images/sister-concern/logo8.png" alt="Fly Dubai"></div>
          </div>
        </div>
      </div>
    </div>
        ...
        if (box.querySelector('[name="travelers"]')) {
            ...
            box.querySelectorAll('input[name="cabinClass"]').forEach(input => {
                input.addEventListener('change', function(e) {
                    ...
                    state.cabinClass = e.target.value.charAt(0).toUpperCase() + e.target.value.slice(1);
                    updateDisplay();
                });
            });
...
<script>
  ...
  if (journeySection) {
      ...
      observer.observe(journeySection, { childList: true, subtree: true });
  }
