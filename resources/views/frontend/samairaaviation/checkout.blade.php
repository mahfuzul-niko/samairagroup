...
<body>
  ...
  <form class="content-margin-top">
    <div class="aviation-checkout-container">
      ...
      <div class="user-info-form mb-4">
        <div class="row g-3">
          ...
          <div class="col-md-12 form-group position-relative">
            ...
            <textarea class="form-control ps-5" id="special_request" name="special_request" rows="4" placeholder="Write your special request here..."></textarea>
          </div>
        </div>
      </div>
      ...
      <a class="edit-link" href="#">Edit Information</a>
    </div>
  </form>
