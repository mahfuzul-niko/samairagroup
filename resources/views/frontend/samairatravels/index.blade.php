                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="hero-images">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/hero-slider/Traveller.png"
                                        class="girl" alt="girl">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/hero-slider/plane.png"
                                        class="plane2" alt="plane2">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item">
                        <div class="service-icon">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/service/1.png"
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item active">
                        <div class="service-icon">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/service/2.png"
                                alt="Best Flights">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item">
                        <div class="service-icon">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/service/3.png"
                                alt="Local Events">
                        </div>
                        <h3 class="service-title">Local Events</h3>
                        <p class="service-text">Barton vanity itself do in it. Preferd to men it engrossed listening.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-item">
                        <div class="service-icon">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/service/4.png"
                                alt="Customization">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="destination-item">
                        <div class="destination-image">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/destination/1.png"
                                alt="Rome, Italy">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="destination-item">
                        <div class="destination-image">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/destination/2.jpg"
                                alt="London, UK">
                        </div>
                        <div class="destination-content">
                            <div class="destination-info">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="destination-item">
                        <div class="destination-image">
                            <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/destination/3.png"
                                alt="Full Europe">
                        </div>
                        <div class="destination-content">
                            <div class="destination-info">
                        ...
                        <div class="booking-steps">
                            ...
                            <div class="booking-step">
                                <div class="step-icon" style="background-color: #F0BB1F;">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/trip/icon1.png"
                            ...
                            <div class="booking-step">
                                <div class="step-icon" style="background-color: #F15A2B;">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/trip/icon2.png"
                                        alt="Make Payment">
                                </div>
                                <div class="step-content">
                                    <h3>Make Payment</h3>
                            ...
                            <div class="booking-step">
                                <div class="step-icon" style="background-color: #006380;">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/trip/icon3.png"
                                        alt="Reach Airport">
                                </div>
                                <div class="step-content">
                    ...
                    <div class="trip-cards-wrapper">
                        ...
                        <div class="trip-card">
                            <div class="trip-image">
                                <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/trip/pic.jpg"
                                    alt="Trip to Greece">
                            </div>
                        ...
                        <div class="ongoing-trip">
                            <div class="ongoing-trip-content">
                                <div class="ongoing-trip-icon">
                                    <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/trip/mosq.png"
                                        alt="Rome">
                                </div>
                    ...
                    <div class="testimonial-slide active">
                        <div class="testimonial-content">
                            <div class="testimonial-image">
                                <img src="{{ asset('assets/frontassets/') }}/images/samaira-travels/testimonial/person.png"
                                    alt="Mike Taylor">
                            </div>
                            <p class="testimonial-text">"On the Windows talking painted pasture yet its express parties
