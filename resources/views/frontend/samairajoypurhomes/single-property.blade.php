      ...
      <div class="col-md-6">
        <div class="product-image-slider-container">
          <div class="main-image">
            <img id="mainProductImage" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/2.png" alt="Product Image" />
          </div>
          <div class="thumbnail-images">
            <div class="swiper thumbnail-swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img class="thumbnail selected" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/2.png" alt="Thumbnail 1" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/2.png" /></div>
      ...
      <div class="col-md-6">
        <div class="product-details enhanced-details">
          ...
          <div class="d-flex align-items-start justify-content-between mb-2">
            <h2 class="product-title mb-1">Embrace Sideboard Embrace Sideboard Embrace Sideboard Embrace Sideboard Embrace Sideboard</h2>
            <div class="icon-group">
              <button class="icon-btn share-btn" id="shareBtn" title="Share"><i class="fa fa-share-alt"></i></button>
            </div>
          </div>
          <div class="product-brand mb-3"><i class="fa fa-map-marker-alt"></i> 1800-1818 79th St</div>
          ...
          <div class="mb-4">
            <div class="product-meta-row d-flex align-items-start mb-3 flex-wrap">
                <div class="price-col d-flex flex-column align-items-start me-4">
                  ...
                  <div class="product-brand mb-3"><i class="fa fa-calendar-alt"></i> 9/8/2025</div>
                </div>
                <div class="price-col d-flex flex-column align-items-start me-4">
                  <span class="product-type">Built In Year</span>
                  <div class="product-brand mb-3"><i class="fa fa-calendar-alt"></i> 2025</div>
                </div>
              </div>
          </div>
          <div class="mb-4">
            <div class="product-meta-row d-flex align-items-start mb-3 flex-wrap">
                <div class="price-col d-flex flex-column align-items-start me-4">
                  ...
                  <div class="product-brand mb-3"><i class="fa fa-bed"></i> 3</div>
                </div>
                <div class="price-col d-flex flex-column align-items-start me-4">
                  <span class="product-type">Bathrooms</span>
                  <div class="product-brand mb-3"><i class="fa fa-bath"></i> 2</div>
                </div>
                <div class="price-col d-flex flex-column align-items-start me-4">
                  <span class="product-type">Floor Area (sqft)</span>
                  <div class="product-brand mb-3"><i class="fa fa-area-chart"></i> 1200</div>
                </div>
              </div>
          </div>
          <div class="mb-4">
            <div class="mb-2 choose-label">Choose a floor area (sqft)</div>
            <div class="size-options enhanced-sizes" id="sizeOptions">
              <label><input type="radio" name="size" value="Small" checked> 1000</label>
              <label><input type="radio" name="size" value="Medium"> 1200</label>
              <label><input type="radio" name="size" value="Large"> 1400</label>
              <label><input type="radio" name="size" value="Extra Large"> 1600</label>
              <label><input type="radio" name="size" value="XXL"> 1800</label>
            </div>
          </div>
          <div class="d-flex align-items-center mb-4">
            ...
            <button class="btn btn-primary add-to-cart-btn enhanced-cart-btn"><i class="fa fa-hand-holding-usd me-2"></i>Buy Now</button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="reviews-section p-4">
            ...
            <div class="write-review-form mb-5">
              ...
              <form>
                ...
                <button type="submit" class="btn btn-primary px-5 py-2" style="border-radius: 30px; font-weight: 600; font-size: 1.1rem; background: #3b4266; border: none;">Submit Review</button>
              </form>
            </div>
          </div>
        </div>
