...
<body>
    ...
    <section class="awards-section py-5 gallery-section">
        <div class="container">
            <h2 class="awards-title text-center mb-2">Gallery</h2>
            ...
            <!-- Filter -->
            <div class="filter-bar d-flex flex-wrap justify-content-center gap-2 mb-4 mt-3">
                <button class="btn btn-filter active" data-filter="all">All</button>
                <button class="btn btn-filter" data-filter="award">Awards</button>
                <button class="btn btn-filter" data-filter="certificate">Certificates</button>
