...
<body>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="feature-text mb-0">{{ system_key('system_emerging_freeshipping') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="feature-text mb-0">{{ system_key('system_emerging_securepayment') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="feature-text mb-0">{{ system_key('system_emerging_returnpolicy') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="feature-text mb-0">{{ system_key('system_emerging_certifiedseller') }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Testimonials Section Start -->
     <section class="testimonials-section"
        style="background: url('{{ system_key('samaira_emerging_review') ? Storage::url(system_key('samaira_emerging_review')) : asset('assets/img/no-profile.png') }}') center center/cover no-repeat;">
        <div class="container">
