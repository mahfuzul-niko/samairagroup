  ...
  <section class="featured-section py-5">
    <div class="container">
      ...
      <div class="featured-grid">
        ...
        <!-- Bottom Right 1 -->
        <div class="featured-item featured-small" style="background-image: url('{{ asset('assets/frontassets/') }}/images/samaira-medica/f1.png');">
          <div class="featured-content">
    ...
    <div class="container">
      <div class="service-features-row">
        <div class="service-feature">
          ...
          <p class="service-feature-desc">Free delivery for all orders over $140</p>
        </div>
        <div class="service-feature">
          <div class="service-feature-icon">
          ...
          <p class="service-feature-desc">Friendly 24/7 customer support</p>
        </div>
        <div class="service-feature">
          <div class="service-feature-icon">
          ...
          <p class="service-feature-desc">We return money within 30 days</p>
        </div>
      </div>
    </div>
  </section>
