    ...
    <div class="row mt-5">
      ...
      <div class="col-md-6">
        <div class="product-image-slider-container">
          <div class="main-image">
            <img id="mainProductImage" src="{{ asset('assets/frontassets/') }}/images/samaira-medica/single-product/img.png" alt="Product Image" />
          </div>
          <div class="thumbnail-images">
            <div class="swiper thumbnail-swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><img class="thumbnail selected" src="{{ asset('assets/frontassets/') }}/images/samaira-medica/single-product/img.png" alt="Thumbnail 1" data-img="{{ asset('assets/frontassets/') }}/images/samaira-medica/single-product/img.png" /></div>
                <div class="swiper-slide"><img class="thumbnail" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/2.png" alt="Thumbnail 2" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/2.png" /></div>
                <div class="swiper-slide"><img class="thumbnail" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" alt="Thumbnail 3" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" /></div>
                <div class="swiper-slide"><img class="thumbnail" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" alt="Thumbnail 3" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" /></div>
                <div class="swiper-slide"><img class="thumbnail" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" alt="Thumbnail 3" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" /></div>
                <div class="swiper-slide"><img class="thumbnail" src="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" alt="Thumbnail 3" data-img="{{ asset('assets/frontassets/') }}/images/samaira-joypur-homes/3.png" /></div>
              </div>
      ...
      <div class="col-md-6">
        <div class="product-details enhanced-details">
          <nav class="breadcrumb-nav mb-3 enhanced-breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Decoration</a></li>
              <li class="breadcrumb-item"><a href="#">Furniture</a></li>
              <li class="breadcrumb-item"><a href="#">Storage</a></li>
              <li class="breadcrumb-item active">Sideboard</li>
            </ol>
          </nav>
          <div class="d-flex align-items-center justify-content-between mb-2">
            <h2 class="product-title mb-1">Embrace Sideboard</h2>
            <div class="icon-group">
              <button class="icon-btn favorite-btn" title="Add to Favorites"><i class="fa fa-heart"></i> <span class="fav-count">109</span></button>
              <button class="icon-btn bookmark-btn" title="Bookmark"><i class="fa fa-bookmark"></i></button>
              <button class="icon-btn share-btn" id="shareBtn" title="Share"><i class="fa fa-share-alt"></i></button>
            </div>
          </div>
          <div class="product-brand mb-3">Teixeira Design Studio</div>
          <div class="product-meta-row d-flex align-items-start mb-3 flex-wrap">
            ...
            <div class="meta-col d-flex flex-column align-items-start">
              <div class="meta-badges-row">
                <span class="rating-badge me-2"><i class="fa fa-star"></i> 4.8</span>
                <a href="#reviews" class="review-link me-2">67 Reviews</a>
              </div>
              <span class="recommend-text">93% of buyers have recommended this.</span>
            </div>
          </div>
          <hr>
          <div class="mb-4">
            <div class="mb-2 choose-label">Choose a Color</div>
            <div class="color-options enhanced-colors" id="colorOptions">
              <span class="color-circle color-1 selected" data-color="1"></span>
              <span class="color-circle color-2" data-color="2"></span>
              <span class="color-circle color-3" data-color="3"></span>
              <span class="color-circle color-4" data-color="4"></span>
              <span class="color-circle color-5" data-color="5"></span>
            </div>
          </div>
          <div class="mb-4">
            <div class="mb-2 choose-label">Choose a Size</div>
            <div class="size-options enhanced-sizes" id="sizeOptions">
          ...
          <div class="d-flex align-items-center mb-4">
            <div class="quantity-box enhanced-qty me-3">
              ...
              <input type="text" id="qty-input" value="5" readonly>
              <button class="qty-btn" id="qty-plus">+</button>
            </div>
            <button class="btn btn-primary add-to-cart-btn enhanced-cart-btn"><i class="fa fa-shopping-cart me-2"></i>Add To Cart</button>
          </div>
          <div class="delivery-info enhanced-delivery-info">
            ...
            <div class="delivery-card return-delivery">
              ...
              <div>
                ...
                <span class="delivery-desc">Free 30 days Delivery Return. <a href="#" class="delivery-link">Details</a></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="tab-pane fade" id="reviews" role="tabpanel">
          <div class="reviews-section p-4">
            ...
            <div class="review-summary-card d-flex mb-4">
              <div class="review-summary-left d-flex flex-column align-items-center justify-content-center p-3">
              ...
              <div class="review-summary-right flex-grow-1 p-3">
                <div class="review-bar-row d-flex align-items-center mb-2">
                  ...
                  <div class="review-bar flex-grow-1 me-2"><div class="review-bar-fill" style="width:70%"></div></div>
                  <div class="review-bar-percent">70%</div>
                </div>
                <div class="review-bar-row d-flex align-items-center mb-2">
                  <div class="review-bar-label me-2">4 <i class="fa fa-star text-warning"></i></div>
                  <div class="review-bar flex-grow-1 me-2"><div class="review-bar-fill" style="width:15%"></div></div>
                  <div class="review-bar-percent">15%</div>
                </div>
                <div class="review-bar-row d-flex align-items-center mb-2">
                  <div class="review-bar-label me-2">3 <i class="fa fa-star text-warning"></i></div>
                  <div class="review-bar flex-grow-1 me-2"><div class="review-bar-fill" style="width:10%"></div></div>
                  <div class="review-bar-percent">10%</div>
                </div>
                <div class="review-bar-row d-flex align-items-center mb-2">
                  <div class="review-bar-label me-2">2 <i class="fa fa-star text-warning"></i></div>
                  <div class="review-bar flex-grow-1 me-2"><div class="review-bar-fill" style="width:3%"></div></div>
                ...
                <div class="review-bar-row d-flex align-items-center">
                  ...
                  <div class="review-bar flex-grow-1 me-2"><div class="review-bar-fill" style="width:2%"></div></div>
            ...
            <div class="review-list">
              <div class="review-item d-flex mb-4">
                ...
                <div class="review-content">
                  <div class="review-user fw-bold">Nicolas Cage <span class="review-date">3 days ago</span></div>
                  <div class="review-stars mb-1">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                  ...
                  <div class="review-text mb-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</div>
                  <div class="review-actions">
                    <a href="#" class="me-3 text-muted"><i class="fa fa-thumbs-up"></i> Like</a>
              ...
              <div class="review-item d-flex mb-4">
                ...
                <div class="review-content">
                  <div class="review-user fw-bold">Sr.Robert Downey <span class="review-date">2 days ago</span></div>
                  <div class="review-stars mb-1">
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                    <i class="fa fa-star text-warning"></i>
                  ...
                  <div class="review-text mb-2">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</div>
                  <div class="review-actions">
                    <a href="#" class="me-3 text-muted"><i class="fa fa-thumbs-up"></i> Like</a>
                    <a href="#" class="text-muted"><i class="fa fa-reply"></i> Reply</a>
                  </div>
            ...
            <div class="write-review-form mb-5">
              ...
              <form>
                ...
                <div class="mb-4">
                  ...
                  <textarea class="form-control" rows="4" placeholder="It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English."></textarea>
                </div>
                <button type="submit" class="btn btn-primary px-5 py-2 submit-review-btn">Submit Review</button>
              </form>
            </div>
          </div>
        </div>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="similar-card">
            <div class="similar-card-img"><img src="{{ asset('assets/frontassets/') }}/images/samaira-medica/single-product/product1.png" alt="TDX Sinkers"></div>
            ...
            <div class="similar-card-body">
              ...
              <div class="similar-rating"><span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="similar-rating-count">(121)</span></div>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="similar-card">
            <div class="similar-card-img"><img src="{{ asset('assets/frontassets/') }}/images/samaira-medica/single-product/product2.png" alt="TDX Sinkers"></div>
            <button class="similar-fav-btn"><i class="fa fa-heart"></i></button>
            <div class="similar-card-body">
              <div class="similar-title">TDX Sinkers hello i am here a long product title given here do not know what to write here</div>
              <div class="similar-price">₹ 675.00</div>
              <div class="similar-sub">5 types of shoos available </div>
              <div class="similar-rating"><span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="star"><i class="fa fa-star"></i></span> <span class="similar-rating-count">(121)</span></div>
            </div>
        ...
        <div class="swiper-slide">
          <div class="similar-card">
            <div class="similar-card-img"><img src="{{ asset('assets/frontassets/') }}/images/similar/4.png" alt="TDX Sinkers"></div>
            <button class="similar-fav-btn"><i class="fa fa-heart"></i></button>
            <div class="similar-card-body">
              <div class="similar-title">TDX Sinkers</div>
              <div class="similar-price">₹ 675.00</div>
        ...
        <div class="swiper-slide">
          <div class="similar-card">
            <div class="similar-card-img"><img src="{{ asset('assets/frontassets/') }}/images/similar/5.png" alt="TDX Sinkers"></div>
            <button class="similar-fav-btn"><i class="fa fa-heart"></i></button>
            <div class="similar-card-body">
              <div class="similar-title">TDX Sinkers</div>
              <div class="similar-price">₹ 675.00</div>
        ...
        <div class="swiper-slide">
          <div class="similar-card">
            <div class="similar-card-img"><img src="{{ asset('assets/frontassets/') }}/images/similar/6.png" alt="TDX Sinkers"></div>
            <button class="similar-fav-btn"><i class="fa fa-heart"></i></button>
            <div class="similar-card-body">
              <div class="similar-title">TDX Sinkers</div>
              <div class="similar-price">₹ 675.00</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content share-modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close share-modal-close" data-bs-dismiss="modal" aria-label="Close" style="filter: invert(0%) brightness(0%) contrast(100%); font-size: 6px;"></button>
        </div>
        <div class="modal-body d-flex flex-column align-items-center py-4">
          <div class="mb-2 text-center">
            <div class="fw-semibold" style="font-size:1.1rem;">Share this property with family and friends</div>
          </div>
          <div class="share-icons mb-3">
            <a href="#" class="share-social-btn facebook" id="fbShareBtn" title="Share on Facebook"><i class="fab fa-facebook-f"></i></a>
            <a href="#" class="share-social-btn twitter" id="twShareBtn" title="Share on Twitter"><i class="fab fa-twitter"></i></a>
            <button class="share-social-btn email" id="showEmailForm" title="Share via Email" type="button"><i class="fa fa-envelope"></i></button>
            <button class="share-social-btn copylink" id="copyLinkBtn" title="Copy Link" type="button"><i class="fa fa-link"></i></button>
          </div>
          <form id="emailShareForm" style="display:none; width:100%; max-width:340px;">
            ...
            <button type="submit" class="btn btn-primary w-100"><i class="fa fa-envelope"></i> Send a message</button>
          </form>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('copyLinkBtn').onclick = function() {
      navigator.clipboard.writeText(window.location.href).then(function() {
        ...
        setTimeout(() => document.getElementById('copyLinkMsg').style.display = 'none', 2000);
      });
    };
    ...
    document.getElementById('emailShareForm').onsubmit = function(e) {
      ...
      window.location.href = `mailto:${to}?subject=Check this property&body=${msg}%0A${window.location.href}`;
    };
    ...
    document.getElementById('fbShareBtn').setAttribute('href', `https://www.facebook.com/sharer/sharer.php?u=${postUrl}`);
    document.getElementById('twShareBtn').setAttribute('href', `https://twitter.com/intent/tweet?url=${postUrl}&text=${postTitle}`);
    ...
    document.querySelectorAll('#colorOptions .color-circle').forEach(circle => {
      circle.addEventListener('click', function() {
        document.querySelectorAll('#colorOptions .color-circle').forEach(c => c.classList.remove('selected'));
    ...
    document.querySelectorAll('#sizeOptions input[type="radio"]').forEach(radio => {
      radio.addEventListener('change', function() {
        document.querySelectorAll('#sizeOptions label').forEach(label => label.classList.remove('selected'));
