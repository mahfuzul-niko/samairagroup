    ...
    <div class="container">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-7 mb-4 mb-md-0">
                <iframe src="{{ system_key('system_footer_map') }}" width="750" height="250" style="border:0;"
            ...
            <div class="col-md-3">
                ...
                <address class="text-info">
                    ...
                    <a href="https://wa.me/{{ ltrim(system_key('system_footer_whatsapp'), '+') }}" target="_blank"
                        class="text-info text-decoration-underline">WhatsApp:</a><br>
                    <a href="https://wa.me/{{ ltrim(system_key('system_footer_whatsapp'), '+') }}" target="_blank"
                        class="text-decoration-none text-dark">{{ system_key('system_footer_whatsapp') }}</a><br>
        ...
        <div class="row border-top pt-3 align-items-center bottom-footer">
            ...
            <div class="col-md-4 d-flex justify-content-md-end justify-content-center gap-3 mt-3 mt-md-0">
                <a href="{{ system_key('system_footer_facebook') }}" class="rounded-circle d-flex align-items-center justify-content-center"><i
                        class="fab fa-facebook-f"></i></a>
                <a href="{{ system_key('system_footer_youtube') }}" class="rounded-circle d-flex align-items-center justify-content-center"><i
                        class="fab fa-youtube"></i></a>
                <a href="{{ system_key('system_footer_x') }}" class="rounded-circle d-flex align-items-center justify-content-center"><i
                        class="fab fa-twitter"></i></a>
                <a href="{{ system_key('system_footer_linkedin') }}" class="rounded-circle d-flex align-items-center justify-content-center"><i
